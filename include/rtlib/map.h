...
#define __map_methods_h(container_t, key_t, value_t)                                            \
...
#define __static_map_methods_c(container_t, key_t, value_t, container_capacity)                                \
    ...
    {                                                                                                          \
        ...
        return self->size == 0;                                                                                \
                                                                                                               ...
                                                                                                               \
    int container_t##_Insert(container_t * const self, key_t key, value_t val)                                 \
    {                                                                                                          \
        assert(self);                                                                                          \
                                                                                                               \
            ...
            {                                                                                                  \
                ...
                {                                                                                              \
                    parent_node = child_node;                                                                  \
                                                                                                               \
                    int compare_value = key_t##_Compare((const key_t *)&key, (const key_t *)&child_node->key); \
                    if(compare_value < 0)                                                                      \
                    {                                                                                          \
    ...
    {                                                                                                          \
        ...
        {                                                                                                      \
            ret = container_t##_Iterator_Ref(&it).second;                                                      \
        }                                                                                                      \
        return ret;                                                                                            \
    }                                                                                                          \
                                                                                                               \
    ...
    {                                                                                                          \
        ...
        while(node)                                                                                            \
        {                                                                                                      \
            int compare_result = key_t##_Compare((const key_t *)&key, (const key_t *)&node->key);              \
            if(compare_result == 0)                                                                            \
            {                                                                                                  \
                break;                                                                                         \
            }                                                                                                  \
...
#define __custom_allocator_map_methods_c(container_t, key_t, value_t, allocator_t)                              \
                                                                                                                \
    static container_t##_node * __##container_t##_GetNextNode(container_t##_node * node)                        \
    {                                                                                                           \
        if(!node)                                                                                               \
    ...
    {                                                                                                           \
        ...
        return self->size == 0;                                                                                 \
                                                                                                                ...
                                                                                                                \
    int container_t##_Insert(container_t * const self, key_t data, value_t value)                               \
    {                                                                                                           \
        assert(self);                                                                                           \
                                                                                                                \
...
#define static_map(container_t, key_t, value_t, container_capacity)          \
    ...
    __map_methods_h(container_t, key_t, value_t)

#define static_map_impl(container_t, key_t, value_t, container_capacity)          \
    static_pool_impl(container_t##_pool, container_t##_node, container_capacity); \
    __static_map_methods_c(container_t, key_t, value_t, container_capacity)

#define custom_allocator_map(container_t, key_t, value_t, allocator_t) \
    pair(container_t##_Pair, const key_t *, value_t *);                \
    pair(container_t##_CPair, const key_t *, const value_t *);         \
    typedef struct container_t container_t;                            \
    typedef struct container_t##_Iterator container_t##_Iterator;      \
...
#define custom_allocator_map_impl(container_t, key_t, value_t, allocator_t) \
    __custom_allocator_map_methods_c(container_t, key_t, value_t, allocator_t)

#define dynamic_map(container_t, key_t, value_t)    \
    dynamic_memory(container_t##_DynamicAllocator); \
    custom_allocator_map(container_t, key_t, value_t, container_t##_DynamicAllocator);

#define dynamic_map_impl(container_t, key_t, value_t)    \
    dynamic_memory_impl(container_t##_DynamicAllocator); \
    custom_allocator_map_impl(container_t, key_t, value_t, container_t##_DynamicAllocator);
